...
from cs336_alignment.utils import tokenize_prompt_and_output,compute_entropy,get_response_log_probs,masked_normalize,sft_microbatch_train_step,compute_group_normalized_rewards,compute_naive_policy_gradient_loss,compute_grpo_clip_loss,masked_mean,compute_policy_gradient_loss,grpo_microbatch_train_step
...
def run_compute_group_normalized_rewards(
    ...
    """
    #raise NotImplementedError
    return compute_group_normalized_rewards(reward_fn, rollout_responses, repeated_ground_truths,group_size, advantage_eps=advantage_eps, normalize_by_std=normalize_by_std)
